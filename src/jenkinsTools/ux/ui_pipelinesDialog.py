...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.descriptionLabel.setGeometry(QRect(380, 150, 91, 16))
        ...
        self.scriptLabel.setGeometry(QRect(380, 90, 91, 16))
        self.scriptPathLabel = QLabel(self.page)
        self.scriptPathLabel.setObjectName(u"scriptPathLabel")
        self.scriptPathLabel.setGeometry(QRect(380, 120, 91, 16))
